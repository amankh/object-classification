...
class vgg_weights(tf.train.SessionRunHook):
     def begin(self):
         tf.contrib.framework.init_from_checkpoint('logs/task4_1/vgg_16.ckpt', vgg_mapping)
...
def main():
    ...
    pascal_classifier.train(input_fn=train_input_fn, 
	steps=NUM_ITERS, 
	hooks=[logging_hook, vgg_init_weights])
