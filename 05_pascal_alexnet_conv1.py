...
def main():
    ...
    if log_map == True:
        ...
        meanmapFile = open('task5_mean_map.txt','w')
    ...
    for it in range(5):
        ...
        conv_weight = pascal_classifier.get_variable_value('conv2d/kernel')

        log_conv_weight.append(conv_weight)
    ...
    np.save('logs/conv_data', log_conv_weight)

    with open("05_pascal_alexnet_conv.npz",'w') as conv_weightFile:
        np.save(conv_weightFile, log_conv_weight )
